...
class RetrievalDecoding(DecodingStrategy):
    def __init__(self, trigger, control_text, cluster_label, n_cluster=3, encoder=None, past_adv_texts=None, device=file_device, should_natural=True):
        self.device = device
        ...
        fp = './datasets/ms_marco_trigger_queries.json'
        with open(fp, 'r') as f:
        ...
        # Perform clustering to select reference embeddings
